...
import io.ratismal.triggers.common.tileentity.TileData;
...
public class BlockData extends BaseBlock implements ITileEntityProvider {
    ...
    public BlockData() {
        super(RefBlocks.dataBlock);
        GameRegistry.registerBlock(this, RefBlocks.dataBlock);

        GameRegistry.registerTileEntity(TileData.class, RefBlocks.dataBlock);
    }
