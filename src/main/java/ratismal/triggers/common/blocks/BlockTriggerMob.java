...
public class BlockTriggerMob extends BlockEmitter implements ITileEntityProvider {

    public BlockTriggerMob() {
        super(RefBlocks.BLOCK_TRIGGER_MOB);
        GameRegistry.registerTileEntity(TileTriggerProximity.class, RefBlocks.BLOCK_TRIGGER_MOB);
    }
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        if (!te.isNoCol() && collidingEntity instanceof EntityMob && !worldIn.isRemote) {
